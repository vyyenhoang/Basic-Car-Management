...
namespace FinalProject.Controllers
{
    public class VehiclesController : Controller
    {
        ...
        {
            var vehicles = db.Vehicles.Include(v => v.CarModel).Include(v => v.Make);
        ...
        {
            ViewBag.ModelId = new SelectList(db.CarModels, "ModelId", "Colour");
        ...
        public ActionResult Create([Bind(Include = "VehicleId,MakeId,ModelId,Year,Price,Cost,SoldDate,CreateDate,EditDate")] Vehicle vehicle)
        {
            ...
            ViewBag.ModelId = new SelectList(db.CarModels, "ModelId", "Colour", vehicle.ModelId);
